...
for (const user of users) {
    for (const sonido in user.favoritesSounds){
        const volumen = user.favoritesSounds[sonido].volume;
        volumenes += volumen;
        contadorVolumenes ++;
    }
}
let mediaVolumenes = volumenes / contadorVolumenes;
console.log("La media del volumen de todos los sonidos favoritos que tienen los usuarios es: "+ mediaVolumenes);