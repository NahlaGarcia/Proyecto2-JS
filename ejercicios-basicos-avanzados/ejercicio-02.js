...
//Crea tres variables con la siguiente información: nombre: "Leia", apellido: "Organa", edad: 20
const nombre = "Leia";
const apellido = "Organa";
let edad = 20;

//Muestra un mensaje por consola que siga la siguiente estructura:
//"Soy Leia Organa, tengo 20 años y soy una princesa de Alderaan." (Utiliza la concatenación para ello.)
...
let costeSables = sable1.precio + sable2.precio;
console.log(costeSables);
